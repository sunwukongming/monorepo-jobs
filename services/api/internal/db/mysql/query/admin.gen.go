...
func newAdmin(db *gorm.DB, opts ...gen.DOOption) admin {
	...
	_admin.Type = field.NewInt32(tableName, "type")
	_admin.FatherAdminID = field.NewInt32(tableName, "father_admin_id")
	_admin.CountPassage = field.NewInt32(tableName, "count_passage")
	_admin.CountApply = field.NewInt32(tableName, "count_apply")
	_admin.CountRelay = field.NewInt32(tableName, "count_relay")
	_admin.Status = field.NewInt32(tableName, "status")
	_admin.CompanyID = field.NewInt32(tableName, "company_id")
	_admin.Score = field.NewInt32(tableName, "score")
...
type admin struct {
	...
	Type          field.Int32 // 0=总账户、1=企业账户、2=HR账户、3=特别企业账户
	FatherAdminID field.Int32
	CountPassage  field.Int32
	CountApply    field.Int32
	CountRelay    field.Int32
	Status        field.Int32 // 0、正常，1、审核中，2、停用
...
func (a *admin) updateTableName(table string) *admin {
	...
	a.FatherAdminID = field.NewInt32(table, "father_admin_id")
	a.CountPassage = field.NewInt32(table, "count_passage")
	a.CountApply = field.NewInt32(table, "count_apply")
	a.CountRelay = field.NewInt32(table, "count_relay")
	a.Status = field.NewInt32(table, "status")
	a.CompanyID = field.NewInt32(table, "company_id")
	a.Score = field.NewInt32(table, "score")
...
func (a *admin) fillFieldMap() {
	...
	a.fieldMap["father_admin_id"] = a.FatherAdminID
	a.fieldMap["count_passage"] = a.CountPassage
	a.fieldMap["count_apply"] = a.CountApply
	a.fieldMap["count_relay"] = a.CountRelay
