...
func newBanner(db *gorm.DB, opts ...gen.DOOption) banner {
	...
	_banner.ID = field.NewUint32(tableName, "id")
	_banner.URL = field.NewString(tableName, "url")
	_banner.Type = field.NewString(tableName, "type")
	_banner.JumpURL = field.NewString(tableName, "jump_url")
	_banner.Sort = field.NewUint32(tableName, "sort")
...
func (b *banner) updateTableName(table string) *banner {
	...
	b.JumpURL = field.NewString(table, "jump_url")
	b.Sort = field.NewUint32(table, "sort")
