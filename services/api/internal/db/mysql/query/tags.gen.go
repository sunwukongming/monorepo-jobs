...
func newTags(db *gorm.DB, opts ...gen.DOOption) tags {
	...
	_tags.tagsDo.UseModel(&model.Tags{})

	tableName := _tags.tagsDo.TableName()
	_tags.ALL = field.NewAsterisk(tableName)
	_tags.ID = field.NewInt32(tableName, "id")
	_tags.Tag = field.NewString(tableName, "tag")
...
type ITagsDo interface {
	...
	Unscoped() ITagsDo
	Create(values ...*model.Tags) error
	CreateInBatches(values []*model.Tags, batchSize int) error
	Save(values ...*model.Tags) error
	First() (*model.Tags, error)
	Take() (*model.Tags, error)
	Last() (*model.Tags, error)
	Find() ([]*model.Tags, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Tags, err error)
	FindInBatches(result *[]*model.Tags, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*model.Tags) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*model.Tags, error)
	FirstOrCreate() (*model.Tags, error)
	FindByPage(offset int, limit int) (result []*model.Tags, count int64, err error)
...
func (t tagsDo) Create(values ...*model.Tags) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagsDo) CreateInBatches(values []*model.Tags, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagsDo) Save(values ...*model.Tags) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagsDo) First() (*model.Tags, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*model.Tags), nil
	}
}

func (t tagsDo) Take() (*model.Tags, error) {
...
func (t tagsDo) Last() (*model.Tags, error) {
...
func (t tagsDo) Find() ([]*model.Tags, error) {
	result, err := t.DO.Find()
	return result.([]*model.Tags), err
}

func (t tagsDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*model.Tags, err error) {
	buf := make([]*model.Tags, 0, batchSize)
...
func (t tagsDo) FindInBatches(result *[]*model.Tags, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagsDo) FirstOrInit() (*model.Tags, error) {
...
func (t tagsDo) FirstOrCreate() (*model.Tags, error) {
...
func (t tagsDo) FindByPage(offset int, limit int) (result []*model.Tags, count int64, err error) {
...
func (t tagsDo) Delete(models ...*model.Tags) (result gen.ResultInfo, err error) {
